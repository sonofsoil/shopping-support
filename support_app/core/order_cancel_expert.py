...
def decide_cancel_order(days_to_deliver : str) -> str :
    """ Given the number of days to deliver the order,decides
     whether the order need to be canceled.
    ...
    prompt = prompt_template.format(days=days_to_deliver)
    #print(prompt)
